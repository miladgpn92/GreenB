                ...
                options.Events = new JwtBearerEvents
                {
                    OnAuthenticationFailed = context =>
                    {
                        if (context.Exception != null)
                            if (context.Exception.Message.Contains("The token is expired") || context.Exception.InnerException.Message.Contains("The token is expired"))
                            {
                                throw new AppException(ApiResultStatusCode.TokenIsExpired, "Authentication failed.", HttpStatusCode.Unauthorized, context.Exception,null);
                            }
                            else
